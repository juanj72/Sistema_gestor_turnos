...
`);
    ...
    initSounds() {
        ...
        this.sounds.success = Utils.loadSound("static/assets/success.wav");
        this.sounds.denied = Utils.loadSound("static/assets/denied.wav");
        this.sounds.tap = Utils.loadSound("static/assets/tap.wav");
    }
